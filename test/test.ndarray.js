...
tape( 'the function throws an error if provided a fifth argument which is not an array-like object', function test( t ) {
	var values;
	var i;
...
tape( 'the function throws an error if provided a sixth argument which is not an integer', function test( t ) {
	var values;
	var i;
...
tape( 'the function throws an error if provided a seventh argument which is not a nonnegative integer', function test( t ) {
	var values;
	var i;
...
tape( 'the function throws an error if provided a fifth argument which has insufficient elements', function test( t ) {
	var values;
	var i;
...
tape( 'the function computes the cube root of each element', function test( t ) {
	var expected;
	var len;
	var t1;
	var t2;
